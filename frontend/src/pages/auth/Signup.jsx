...
const Signup = () => {
  ...
  const getStrength = (p) => {
    ...
    if (p.length < 6) return { w: "30%", color: "#FF6B6B", label: "Weak" };
    if (p.length < 10) return { w: "65%", color: "#FBBF24", label: "Fair" };
    return { w: "100%", color: "#34D399", label: "Strong" };
  };
  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <p className="auth-subtitle">Join thousands of amazing users today</p>
